  ...
  return (
    <div>
      ...
      <div className='flex items-center justify-center'>
        <div className={`${isMenuExpanded ? 'w-[72px] justify-center duration-500' : 'px-[34px] w-11/12 max-w-full justify-between duration-700'} py-[14px] flex items-center bg-[#1F2937] h-[72px] fixed rounded-full bottom-[52px] z-20 transition-all `}>
