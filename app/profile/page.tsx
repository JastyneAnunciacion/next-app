    ...
    <MainComponents footerPage='Profile'>
      <div className='px-4'>
        ...
        <div className='relative w-full flex flex-col gap-2 items-center text-white'>
          <div className='absolute w-full h-[295.08px] flex-shrink-0 top-[-19px] z-0'>
            <Image className='z-0' src={`${basePath}/images/profile-page-bg-design.png`} alt='Large Profile Icon' width={561.36} height={295.08}>
            </Image>
          </div>
